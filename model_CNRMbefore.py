...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug  9 21:17:48 2022
...
#print(rmse)
#print(number)
file=open('/dpvhome/dpv16/output/CNRMb1','a')
for i in mtce:
    for j in i:
        file.write(str(j)+',')
    file.write('\n')
...
#print(rmse)
#print(num)
file=open('/dpvhome/dpv16/output/CNRMb2','a')
for i in mtce:
    for j in i:
        file.write(str(j)+',')
    file.write('\n')
...
#print(rmse)
#print(num)
file=open('/dpvhome/dpv16/output/CNRMb3','a')
for i in mtce:
    for j in i:
        file.write(str(j)+',')
    file.write('\n')
