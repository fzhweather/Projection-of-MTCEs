...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug  9 21:31:54 2022
...
start=1950
data1=[]
table=xlrd.open_workbook('/dpvhome/dpv16/CMIP6/MRItable/mri-20km.xlsx')
...
#print(rmse)
#print(number)
file=open('/dpvhome/dpv16/output/mri20b1','w')
for i in mtce:
    for j in i:
        file.write(str(j)+',')
    file.write('\n')
...
#print(rmse)
#print(number)  
file=open('/dpvhome/dpv16/output/mri20b2','w') 
for i in mtce:
    for j in i:
        file.write(str(j)+',')
    file.write('\n')
...
#print(rmse)
#print(number)  
file=open('/dpvhome/dpv16/output/mri20b3','w')
for i in mtce:
    for j in i:
        file.write(str(j)+',')
    file.write('\n')
