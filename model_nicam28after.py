...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 10 18:08:47 2022
...
start=1950
data1=[]
table=xlrd.open_workbook('/dpvhome/dpv16/CMIP6/MRItable/nicam-28.xlsx')
...
file=open('/dpvhome/dpv16/output/nicam281','a')
for i in mtce:
    for j in i:
        file.write(str(j)+',')
    file.write('\n')
...
for i in range(numyear):
    for j in range(12):
        stcn[i].append(len(set(stce[i][j])))
file=open('/dpvhome/dpv16/output/nicam282','a')
for i in mtce:
    for j in i:
        file.write(str(j)+',')
    file.write('\n')
...
for i in range(numyear):
    for j in range(12):
        stcn[i].append(len(set(stce[i][j])))
file=open('/dpvhome/dpv16/output/nicam283','a')
for i in mtce:
    for j in i:
        file.write(str(j)+',')
    file.write('\n')
