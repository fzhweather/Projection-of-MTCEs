...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug  9 21:34:59 2022
...
#print(rmse)
#print(number)
file=open('/dpvhome/dpv16/output/nicam28b1','w')
for i in mtce:
    for j in i:
        file.write(str(j)+',')
    file.write('\n')
...
#print(rmse)
#print(number)  
file=open('/dpvhome/dpv16/output/nicam28b2','w') 
for i in mtce:
    for j in i:
        file.write(str(j)+',')
    file.write('\n')
...
#print(rmse)
#print(number)  
file=open('/dpvhome/dpv16/output/nicam28b3','w')
for i in mtce:
    for j in i:
        file.write(str(j)+',')
    file.write('\n')
