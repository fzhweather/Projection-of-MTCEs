...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 25 09:01:31 2022
...
#print(r_ab)
#print(len(frequency))
t = Dataset(r'/dpvhome/dpv16/CMIP6/EC-Earth/TC-NH_TRACK_EC-Earth3P-HR_highresSST-present_r1i1p1f1_gr_19500101-20141231.nc')
t2 = open_dataset(r'/dpvhome/dpv16/CMIP6/EC-Earth/TC-NH_TRACK_EC-Earth3P-HR_highresSST-present_r1i1p1f1_gr_19500101-20141231.nc',use_cftime=True)
...
t3 = Dataset(r'/dpvhome/dpv16/CMIP6/EC-Earth/TC-NH_TRACK_EC-Earth3P-HR_highresSST-present_r2i1p1f1_gr_19500101-20141231.nc')
t4 = open_dataset(r'/dpvhome/dpv16/CMIP6/EC-Earth/TC-NH_TRACK_EC-Earth3P-HR_highresSST-present_r2i1p1f1_gr_19500101-20141231.nc',use_cftime=True)
...
t5 = Dataset(r'/dpvhome/dpv16/CMIP6/EC-Earth/TC-NH_TRACK_EC-Earth3P-HR_highresSST-present_r3i1p1f1_gr_19500101-20141231.nc')
t6 = open_dataset(r'/dpvhome/dpv16/CMIP6/EC-Earth/TC-NH_TRACK_EC-Earth3P-HR_highresSST-present_r3i1p1f1_gr_19500101-20141231.nc',use_cftime=True)
...
file=open('/dpvhome/dpv16/output/ECE1','a')
for i in mtce:
    for j in i:
        file.write(str(j)+',')
    file.write('\n')
...
for i in range(numyear):
    for j in range(12):
        stcn[i].append((len(set(stce1[i][j]))+len(set(stce2[i][j]))+len(set(stce3[i][j])))/3)
file=open('/dpvhome/dpv16/output/ECE2','a')
for i in mtce:
    for j in i:
        file.write(str(j)+',')
    file.write('\n')
...
for i in range(numyear):
    for j in range(12):
        stcn[i].append((len(set(stce1[i][j]))+len(set(stce2[i][j]))+len(set(stce3[i][j])))/3)
file=open('/dpvhome/dpv16/output/ECE3','a')
for i in mtce:
    for j in i:
        file.write(str(j)+',')
    file.write('\n')
